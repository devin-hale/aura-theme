local function createTreeSitterGroup(palette, aura)
  return {
    ...
    ['@lsp.type.type'] = aura.Blue,
    ['@lsp.type.namespace'] = aura.Orange,
    ['@lsp.type.class'] = aura.Blue,
    ['@lsp.type.enum'] = '@type',
    ['@lsp.type.interface'] = '@type',
    ['@lsp.type.struct'] = '@structure',
    ['@lsp.type.parameter'] = aura.Orange,
    ['@lsp.type.variable'] = '@variable',
    ['@lsp.type.property'] = aura.Pink,
    ['@lsp.type.enumMember'] = aura.Pink,
